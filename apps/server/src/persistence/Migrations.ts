...
import Migration0044 from "./Migrations/044_ProjectionProjectsBoardItems.ts";
import Migration0045 from "./Migrations/045_TerminalSessionRegistry.ts";
...
export const migrationEntries = [
  ...
  [44, "ProjectionProjectsBoardItems", Migration0044],
  [45, "TerminalSessionRegistry", Migration0045],
] as const;
