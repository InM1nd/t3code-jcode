  ...
  const runGrokJson = <S extends Schema.Top>({
    ...
    Effect.gen(function* () {
      ...
      const runtime = yield* makeJcodeAcpRuntime({
        jcodeSettings: { ...jcodeSettings, model: resolvedModel },
        environment,
        childProcessSpawner: commandSpawner,
        cwd,
        clientInfo: { name: "t3-code-jcode-git-text", version: "0.0.0" },
        ...
        return yield* new TextGenerationError({
          ...
          detail:
            promptResult.stopReason === "cancelled"
              ...
              : "Jcode Agent returned empty output.",
        });
      }
        ...
        Effect.catchTags({
          SchemaError: (cause) =>
            Effect.fail(
              new TextGenerationError({
                operation,
                detail: "Jcode Agent returned invalid structured output.",
                cause,
              }),
            ),
        }),
