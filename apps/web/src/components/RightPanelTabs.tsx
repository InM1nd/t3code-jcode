...
function RightPanelEmptyState(props: {
  ...
  const actions = [
    ...
    {
      label: "Board",
      description: "Track project todos across threads.",
      icon: ListTodo,
      shortcut: "O",
      available: props.onAddBoard !== undefined,
      disabledReason: "Board is unavailable in this workspace.",
      onClick: props.onAddBoard ?? NOOP_SURFACE_ACTION,
      badgeCount: 0,
    },
    {
      label: "Activity",
      ...
      icon: History,
      shortcut: "C",
      available: props.onAddActivity !== undefined,
      disabledReason: "Activity is unavailable in this workspace.",
      onClick: props.onAddActivity ?? NOOP_SURFACE_ACTION,
      badgeCount: 0,
    },
  ] as const;
      ...
      <div className="flex min-h-0 flex-1 flex-col" data-right-panel-surface-content>
        {props.activeSurfaceId === null ? (
          <RightPanelEmptyState
            ...
            onAddBoard={props.onAddBoard ?? NOOP_SURFACE_ACTION}
            onAddActivity={props.onAddActivity ?? NOOP_SURFACE_ACTION}
