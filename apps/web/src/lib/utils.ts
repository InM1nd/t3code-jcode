import { CommandId, MessageId, ProjectBoardItemId, ProjectId, ThreadId } from "@t3tools/contracts";
...
export const newProjectBoardItemId = (): ProjectBoardItemId =>
  ProjectBoardItemId.make(randomUUID());
