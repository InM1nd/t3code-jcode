...
export function createOrchestrationEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    projectActivity: createEnvironmentRpcQueryAtomFamily(runtime, {
      label: "environment-data:orchestration:project-activity",
      tag: ORCHESTRATION_WS_METHODS.getProjectActivity,
      staleTimeMs: 30_000,
      idleTtlMs: 60_000,
    }),
